...
% Attention: this m-file requires the Chebfun-toolbox, which can be
% downloaded from www.chebfun.org
%
% Note, that running this file (with sample size 50) may take 20 minutes.
...
legend('Transport of images', 'Chebfun2','Location','NORTHWEST')
xlabel('$n$')
